...
char determinePos(int time) {
	...
	time = time % 171;
	if (time > 0 && time <= 30) pos = 'C';
	else if (time > 30  && time <= 85) pos = 'M';
	else if (time > 85 && time <= 132) pos = 'S';
	else if (time > 132 && time <= 170) pos = 'A';
	else pos = 'C';
...
void display (char pos) {
	...
	if (pos == 'C') subPos = "concrete";
	else if (pos == 'M') subPos = "mud";
	else if (pos == 'S') subPos = "sand";
	else if (pos == 'A') subPos = "asphalt";
