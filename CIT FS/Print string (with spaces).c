...
int main() {
	...
	gotoxy(17, 10);
	printf("Tuition Fee\t  : %.2f", tuition = 309.99*load);
	gotoxy(17, 12);
	printf("Miscellaneous Fee: %.2f", misc = tuition * 0.20);
	gotoxy(17, 14);
	printf("Registration Fee : %.2f", reg = 1000);
	gotoxy(17, 16);
	printf("Health Insurance : %.2f", health = 10);
	gotoxy(36, 17);
	printf("-------");
	gotoxy(17, 18);
	printf("Tuition Fee\t  : %.2f", total = tuition + misc + reg + health);
